...
public class PrefsActivity extends Activity implements OnItemSelectedListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> intAdapter = new ArrayAdapter<String>(this,
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		edit.putInt("listLimit",
				Integer.parseInt(arg0.getSelectedItem().toString()));
		edit.commit();
	}
